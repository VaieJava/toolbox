...
public class VoiceBookNovelServiceImpl implements NovelService {
    ...
    String directoryRule = ".plist ul li a";
    String titleRule=".h-play h1";
    String contentsRule="audio source";
