...
public class CreateTable {
    ...
    static {
        ...
        javaProperty2SqlColumnMap.put("byte[]", "BLOB");
    }
    ...
    public static void main(String[] args) throws IOException {
        createTable(VolumeInfo.class, null,"novel_db.");
// createTable(Book.class, null);
    }

    public static String createTable(Class obj, String tableName,String dbName) throws IOException {
...
//        sb.append("\r\ndrop table if exists  ").append(tableName).append(";\r\n");
        ...
        sb.append("create table "+dbName).append(StringUtil.underscoreName(tableName)).append(" ( \r\n");
...
//            System.out.println(column + "," + f.getType());
            ...
            sb.append(StringUtil.underscoreName(column));//一般第一个是主键
